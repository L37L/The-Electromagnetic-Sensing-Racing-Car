...
pid_param_t smotor_pid;
int16 Duty_result;			//舵机PWM输出
...
*备注：
*********************************************/
void smotor_pin_init(void)
{
	pwm_init(SMOTOR_PIN, 50, 820);
}
...
float Fuzzy_P(float E, float EC)
{
    ...
    float UFF[7] = {1.7, 1.8, 1.9, 2.0, 2.3, 2.8, 3}; // 1.15 2  2.2 2.4 2.6 2.8 3 4}
